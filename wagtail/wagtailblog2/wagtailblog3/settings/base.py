...
# --- 启动时打印警告，确保你连接的是测试环境 ---
print("="*60)
print("     W A R N I N G : 正在运行 (local.py) 测试配置     ")
print(f"  [DB]    连接到 MySQL: {DATABASES['default']['NAME']}")
print(f"  [MONGO] 连接到 MongoDB: {MONGO_DB['NAME']}")
print(f"  [MINIO] 连接到 Bucket: {AWS_STORAGE_BUCKET_NAME}")
print("="*60)
