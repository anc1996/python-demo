...
# def prepare_body_for_save(sender, instance, **kwargs):
#     """保存前准备body字段"""
#     # 如果是已有页面且MongoDB中有内容，确保body为最新
#     if not instance._state.adding and instance.mongo_content_id:
#         # 检查是否在编辑后被清空
#         if not instance.body or not instance.body.raw_data:
#             # 尝试从MongoDB恢复
#             try:
#                 content = instance.get_content_from_mongodb()
#                 if content and 'body' in content:
#                     # 不要在这里设置body内容，那是before_edit_page钩子的工作
#                     pass
#             except:
#                 # 忽略错误，让save方法处理
#                 pass