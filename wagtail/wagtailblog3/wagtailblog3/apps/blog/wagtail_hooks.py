...
def global_admin_css():
    ...
    fontawesome_url = "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
...
def global_admin_js():
    ...
    """
    mermaid_js_url = "https://cdn.jsdelivr.net/npm/mermaid/dist/mermaid.min.js"
    return format_html(
        """
        <script src="{}"></script>
        <script>
