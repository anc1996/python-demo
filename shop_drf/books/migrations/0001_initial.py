# Generated by Django 4.1.13 on 2024-05-21 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.SmallIntegerField(choices=[(0, 'male'), (1, 'female'), (2, 'secrecy')], default=0, verbose_name='性别')),
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.bookinfo', verbose_name='图书')),
            ],
            options={
                'verbose_name': '人物表',
                'db_table': 'peopleinfo',
